            ...
            <section className='flex flex-col'>
                <div className='flex justify-center my-16'>
                    <div
                        ...
                        className="relative transition-opacity duration-300 ease-in-out hover:opacity-100"
                        style={{ clipPath: 'polygon(10% 0, 100% 0, 90% 100%, 0% 100%)' }}
                    >
                        <img src={logoV} alt="Logo de Vipeer" width={400} />
                        {showInfo && (
                            <div className='absolute top-0 left-0 right-0 bottom-0 flex flex-col backdrop-blur-md items-center justify-center text-white opacity-0 hover:opacity-100 transition-opacity duration-300 ease-in-out'>
                    ...
                    >
                        ...
                        {showInfo && (
                            <div className='absolute top-0 left-0 right-0 bottom-0 flex flex-col backdrop-blur-md items-center justify-center text-white opacity-0 hover:opacity-100 transition-opacity duration-300 ease-in-out'>
                                ...
                                <p className='uppercase text-sm font-medium'>23 ans, France</p>
                            </div>
                        )}
                    </div>
                    <div
